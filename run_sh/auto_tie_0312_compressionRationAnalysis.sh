...
# ==================== 模型: epl_apa_mtp_w3e-1_0312_7x ====================
train_model "epl_apa_mtp_w3e-1_0312_7x" "True" "2e-5" "aug-wo-pc-apa-mtp" "configs/epl_apa_mtp.json" "apa_mtp_7x" "8192"
if [ $? -ne 0 ]; then
    echo "❌ epl_apa_mtp_w3e-1_0312_7x训练失败，退出"
    exit 1
fi
inference_and_evaluate "epl_apa_mtp_w3e-1_0312_7x" "anchor-thought" "inference" "./configs/LightThinker/qwen/apa_mtp_7x.json"


# ==================== 模型: epl_apa_mtp_w3e-1_0312_10x ====================
train_model "epl_apa_mtp_w3e-1_0312_10x" "True" "2e-5" "aug-wo-pc-apa-mtp" "configs/epl_apa_mtp.json" "apa_mtp_10x" "8192"
if [ $? -ne 0 ]; then
    echo "❌ epl_apa_mtp_w3e-1_0312_10x训练失败，退出"
    exit 1
fi
inference_and_evaluate "epl_apa_mtp_w3e-1_0312_10x" "anchor-thought" "inference" "./configs/LightThinker/qwen/apa_mtp_10x.json"

...
# ==================== 模型: epl_apa_mtp_w1e-1_0313 ====================
train_model "epl_apa_mtp_w1e-1_0313" "True" "2e-5" "aug-wo-pc-apa-mtp" "configs/epl_apa_mtp_w1e-1.json" "apa_mtp" "8192"
if [ $? -ne 0 ]; then
    echo "❌ epl_apa_mtp_w1e-1_0313训练失败，退出"
    exit 1
fi
inference_and_evaluate "epl_apa_mtp_w1e-1_0313" "anchor-thought" "inference" "./configs/LightThinker/qwen/apa_mtp.json"


# ==================== 模型: epl_apa_mtp_w5e-1_0313 ====================
train_model "epl_apa_mtp_w5e-1_0313" "True" "2e-5" "aug-wo-pc-apa-mtp" "configs/epl_apa_mtp_w5e-1.json" "apa_mtp" "8192"
if [ $? -ne 0 ]; then
    echo "❌ epl_apa_mtp_w5e-1_0313训练失败，退出"
    exit 1
fi

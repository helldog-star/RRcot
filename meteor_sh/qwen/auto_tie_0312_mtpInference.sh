...
#     exit 1
# fi
inference_and_evaluate "epl_apa_mtp_w3e-1" "anchor-thought" "inference" "./configs/LightThinker/qwen/apa_mtp.json" "configs/epl_apa_mtp.json"

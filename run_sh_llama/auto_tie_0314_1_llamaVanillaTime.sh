...
# 模型和Tokenizer路径配置
TOKENIZER_PATH="/tmp/hx/meta-llama/Llama-3.1-8B-Instruct"  # Tokenizer路径
MODEL_PATH="/tmp/hx/meta-llama/Llama-3.1-8B-Instruct"  # 预训练模型路径
...
#     exit 1
# fi
inference_and_evaluate "llama_vanilla" "normal" "inference" "./configs/LightThinker/llama/v1.json"
